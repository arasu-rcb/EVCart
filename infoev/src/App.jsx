          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in duration-300">
            {sortedVehicles.map((vehicle) => {
              ...
              return (
                ...
                >
                  {/* Image Container */}
                  <div className="p-6 pb-2 bg-slate-50/60 dark:bg-slate-950/30 relative flex justify-center items-center h-48 border-b border-slate-100 dark:border-slate-800/30">

                    {/* Category Label */}
                    <span className="absolute top-3 left-3 px-2 py-0.5 rounded bg-slate-200/80 dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 text-[10px] font-bold uppercase tracking-wider">
                      {vehicle.type}
                    </span>
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between">
                    ...
                    <div className="mt-5 pt-3 border-t border-slate-100 dark:border-slate-800/50 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-4 py-2 border border-indigo-600 text-indigo-600 dark:border-indigo-400 dark:text-indigo-400 hover:bg-indigo-600 dark:hover:bg-indigo-400 hover:text-white dark:hover:text-slate-950 text-xs font-bold rounded-lg shadow-sm transition-all cursor-pointer"
                      >
                        Quick View
                      </button>
                    </div>
